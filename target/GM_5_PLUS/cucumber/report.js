...
formatter.match({
  "location": "stepDefinitions.LoginStepDefinitions.iEnterUsernameAs(java.lang.String)"
});
formatter.result({
  "status": "passed"
});
...
formatter.match({
  "location": "stepDefinitions.LoginStepDefinitions.iEnterPasswordAs(java.lang.String)"
});
formatter.result({
  "status": "passed"
});
...
formatter.match({
  "location": "stepDefinitions.LoginStepDefinitions.iLogin()"
});
formatter.result({
  "status": "passed"
});
...
formatter.match({
  "location": "stepDefinitions.LoginStepDefinitions.loginShouldFailWithAnError(java.lang.String)"
});
formatter.result({
  "status": "passed"
});
...
formatter.step({
  "name": "I should see product page with title \"\u003ctitle\u003e\"",
  "keyword": "Then "
});
formatter.examples({
  "name": "",
...
formatter.step({
  "name": "I should see product page with title \"PRODUCTS\"",
  "keyword": "Then "
});
formatter.match({
  "location": "stepDefinitions.LoginStepDefinitions.iShouldSeeProductPageWithTitle(java.lang.String)"
});
formatter.result({
  "status": "passed"
});
